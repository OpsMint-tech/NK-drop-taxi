    ...
    <footer className="w-full text-white bg-cover bg-center" style={{ backgroundImage: "url('/images/footerbg.png')" }}>
      <div className="w-full py-16 px-6 md:px-16 bg-black/80"> {/* Added overlay for better readability if needed, or just rely on image */}
        <Reveal>
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            {/* Column 2: About Site */}
            <div>
              <h3 className="font-bold mb-6 text-white text-lg">About Us</h3>
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                NK Drop Taxi is Tamil Nadu's trusted one-way drop taxi service. We offer affordable, safe, and comfortable rides with professional drivers available 24/7 across all major cities.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="text-gray-400 text-sm space-y-4">
                ...
                <li><Link to="/terms" onClick={handleFooterNavClick} className="hover:text-[#E18B1C] transition-colors">Terms & Conditions</Link></li>
                <li><Link to="/testimonials" onClick={handleFooterNavClick} className="hover:text-[#E18B1C] transition-colors">Testimonials</Link></li>
            ...
            <div>
              ...
              <ul className="text-gray-400 text-sm space-y-4">
                <li>
                  <a href="mailto:enquiry@nkdroptaxi.com" className="hover:text-[#E18B1C] transition-colors">
                ...
                <li>
                  <a href="tel:+918489751086" className="hover:text-[#E18B1C] transition-colors">
                    +91 84897 51086
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-8">
                ...
                <a href="#" className="text-red-600 hover:text-white transition-colors"><FiYoutube size={20} /></a>
                <a href="#" className="text-blue-700 hover:text-white transition-colors"><FiLinkedin size={20} /></a>
              </div>
      ...
      <div className="bg-[#1A1A1A] text-gray-400 text-sm py-4 px-4 md:px-16 border-t border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center gap-2">
          <span>
            © 2026 <span className="text-[#E18B1C]">NKdroptaxi</span> All rights reserved. | Powered by <a href="https://opsmintech.com" target="_blank" rel="noopener noreferrer" className="text-[#E18B1C] hover:text-[#c97b17] transition-colors">opsmintech.com</a>
          </span>
        </div>
      </div>
    </footer>
