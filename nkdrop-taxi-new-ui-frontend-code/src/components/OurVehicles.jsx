...
const cars = [
  ...
  {
    name: 'XYLO',
    image: '/images/xylo_new.jpg',
    seat: '7+1',
    type: 'SUV',
    imageClassName: 'scale-[1.5] hover:scale-[1.6]',
    oneWayPrice: 19,
    roundTripPrice: 18,
    ac: true,
  },
...
export default function OurVehicles() {
  ...
  return (
    <div>
      ...
      <section className="w-full py-12 px-2 md:px-8 border-transparent bg-nk-gradient bg-origin-border bg-clip-padding">
        <div className="max-w-7xl mx-auto">
          <Reveal>
            <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8 text-white">
              Our <span className="font-bold">Vehicles</span>
            </h2>
          </Reveal>
      ...
      <div className="relative w-full h-64 md:h-80 overflow-hidden mt-1">
        {/* Background Image */}
        <div
